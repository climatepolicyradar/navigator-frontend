  ...
  families: [
    {
      ...
      metadata: [
        { name: "family.author", value: "United States" },
    ...
    },
    {
      ...
      metadata: [
        ...
        { name: "family.sector", value: "Industry" },
        { name: "family.keyword", value: "Energy Demand" },
        { name: "family.keyword", value: "Energy Efficiency" },
        { name: "family.instrument", value: "Standards, obligations and norms|Regulation" },
        { name: "family.instrument", value: "MRV|Governance" },
      ],
      family_title_match: true,
      family_description_match: true,
    ...
    },
    {
      ...
      family_geographies: ["USA"],
      metadata: [
        { name: "family.author", value: "National Renewable Energy Laboratory" },
        { name: "family.author_type", value: "National Body" },
      ],
      family_title_match: true,
      family_description_match: true,
      total_passage_hits: 1,
    ...
    },
    {
      ...
      metadata: [
        { name: "family.topic", value: "Mitigation" },
        { name: "family.sector", value: "Energy" },
      ],
      family_title_match: true,
      family_description_match: true,
      total_passage_hits: 3,
    ...
    },
    {
      ...
      metadata: [
        ...
        { name: "family.sector", value: "Energy" },
        { name: "family.sector", value: "Industry" },
        { name: "family.keyword", value: "Coal" },
        { name: "family.keyword", value: "Fossil Fuels" },
      ],
      family_title_match: true,
      family_description_match: true,
      total_passage_hits: 1,
    ...
    },
    {
      ...
      metadata: [
        { name: "family.topic", value: "Mitigation" },
        { name: "family.sector", value: "Finance" },
        { name: "family.sector", value: "Cross Cutting Area" },
        { name: "family.keyword", value: "Energy Transition" },
        { name: "family.keyword", value: "Planning" },
        { name: "family.instrument", value: "Processes, plans and strategies|Governance" },
      ],
      family_title_match: true,
      family_description_match: true,
      total_passage_hits: 1,
    ...
    },
    {
      ...
      family_geographies: ["USA"],
      metadata: [
        { name: "family.author", value: "United States of America" },
        { name: "family.author_type", value: "Party" },
      ],
      family_title_match: true,
      family_description_match: true,
    ...
    },
    {
      ...
      metadata: [
        { name: "family.sector", value: "Energy" },
        { name: "family.sector", value: "Transport" },
        { name: "family.sector", value: "Industry" },
        { name: "family.framework", value: "Mitigation" },
        { name: "family.instrument", value: "Processes, plans and strategies|Governance" },
      ],
      family_title_match: true,
      family_description_match: true,
