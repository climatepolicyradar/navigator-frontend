  ...
  <div className="w-full pt-12 pb-4 text-text-primary px-3 cols-2:px-6 cols-3:px-8">
    <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8">
      <Feature heading="About us" subheading="Learn about this project" image="Homepage-image.png" imageAlt="Climate Case Chart interface">
        ...
        <LinkWithQuery href="/about" className="text-text-brand-darker text-[18px] font-bold">
          Read more →
        </LinkWithQuery>
      </Feature>
      <Feature heading="Get the newsletter" subheading="Stay up to date" image="Newsletter-image.png" imageAlt="Climate Case Chart newsletter">
        ...
        <ExternalLink url="https://mailchi.mp/law/sabin-center-litigation-newsletter" className="text-text-brand-darker text-[18px] font-bold">
          Subscribe →
        </ExternalLink>
      </Feature>
    </div>
