...
export const FeatureDiscover = () => (
  <div className="w-full pt-12 pb-4 text-text-primary px-8">
    <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8">
      <Feature heading="About us" subheading="Learn about this project" image="" imageAlt="Climate Case Chart interface">
      ...
      <Feature heading="Get the newsletter" subheading="Stay up to date" image="" imageAlt="Climate Case Chart newsletter">
        <p className="text-lg leading-relaxed mb-6">
