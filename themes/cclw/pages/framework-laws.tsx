      ...
      <section>
        <div className="container px-4">
          ...
          <div className="text-content mb-12">
            ...
            If you are interested to learn more about climate change framework laws, the Grantham Research Institute at the London School of Economics
            and others have published or contributed to the following open-access resources:
            <ul>
              <li>
            ...
            <p>
              ...
              content of the database, including climate change framework laws we may have missed. We are a small team, and rely on the collaboration
              of our global stakeholders to support our efforts to keep the database up to date.
            </p>
            <p>
              <em>This page was last updated on 22 April 2024</em>.
            </p>
          </div>
        </div>
      </section>
