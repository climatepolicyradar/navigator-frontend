      ...
      <section>
        <div className="container px-4">
          ...
          <div className="text-content mb-12">
            ...
            <p>
              This website provides a user interface for the Climate Policy Radar Database and the Climate Policy Radar Application ("CPR Database and
              App"). The CPR Database builds on over a decade of work at the Grantham Research Institute to provide data and insights on climate
              change law and policy worldwide to support informed and ambitious climate change policymaking and research. The work is underpinned by a
              partnership between the Grantham Research Institute at the London School of Economics and Climate Policy Radar.
            </p>
            <p>
            ...
            <ul>
              ...
              <li>
                ...
                <p className="italic">
                  “This summary was written by researchers at the Grantham Research Institute at the London School of Economics, sourced from Climate
