    ...
    <Layout title="Rio Submissions" description="Rio Policy Radar - a shared tool for climate, nature and land" theme="cpr">
      ...
      <FiveColumns>
        <div className="pt-20 col-start-1 -col-end-1 cols-3:col-start-2 cols-3:-col-end-2 cols-4:-col-end-3 cols-5:col-start-3 cols-5:-col-end-4">
          <span className="block text-[#374151] leading-tight">Rio Policy Radar</span>
          <h1 className="mt-3 mb-6 text-4xl cols-2:text-6xl text-[#030712] font-heavy leading-10 cols-2:leading-14 tracking-[-0.9px]">
            Submissions to&nbsp;the Rio&nbsp;Conventions
          </h1>
          <p className="my-6 text-xl text-[#030712] leading-6">
        ...
        <Link
          ...
          className="max-w-[1200px] w-full mx-auto mt-14 mb-10 col-start-1 -col-end-1 cols-5:col-start-2 cols-5:-col-end-2"
        ...
        >
          <Image
            ...
            width={1200}
            height={699}
            className="w-full bg-white border border-[#d1d5db] rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.10)]0"
          />
        </Link>
        <div className="flex flex-col gap-5 items-center col-start-1 -col-end-1">
          <span className="block text-sm text-[#030712] font-medium leading-4">In collaboration with</span>
        ...
        <main
          ...
          id="examples"
        >
          <p className="mb-3 text-xl text-[#030712] font-heavy leading-7">
          ...
          <h2 className="mb-2 text-xl text-[#030712] font-heavy leading-7">Methodology</h2>
          <p className="mb-6">
