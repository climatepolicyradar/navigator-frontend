    ...
    <Layout title="Ocean Energy Pathway">
      <Section>
        ...
        <div className="my-[80px]">
          <p className="text-lg">
            ...
            industry reports, analyses and policy recommendations from researchers and civil society. You can search for keywords and policy concepts
            across the full text of all documents, viewing your search term and related phrases highlighted in the search results.
          </p>
          {/* image: wind farm */}
        </div>
      </Section>
      ...
      <Section containerClasses="text-lg">
        <Narrow extraClasses="mt-[120px] mb-[160px]">
          ...
          <p className="font-medium text-2xl">
            Offshore wind energy is a key technology for meeting the global target to triple renewables by 2030, keeping the Paris-aligned 1.5 degree
            scenario alive, and bolstering energy security — all while driving economic growth, supporting green industrialisation, and bringing
        ...
        <EqualColumns extraClasses="mb-[200px]">
          ...
          <EqualColumn>
            <p>
              ...
              accessible publications on offshore wind. We have selected high-quality research to provide valuable insights to a global audience. Our
              collection spans a comprehensive range of essential topics related to the sustainable development of offshore wind, including policy
              frameworks, market trends and innovation, socioeconomic impacts, and considerations for environmental sustainability and biodiversity.
            </p>
          </EqualColumn>
        </EqualColumns>
      </Section>
