    ...
    <form data-cy="search-form" ref={formRef} onSubmit={(e) => e.preventDefault()}>
      <div className="max-w-screen-lg mx-auto flex items-stretch relative text-white">
        <input
          ...
          type="search"
          className="text-white placeholder:text-white py-4 pr-16 text-2xl bg-transparent border-t-0 border-l-0 border-r-0 border-white border-b-2 focus:border-white focus:ring-0 w-full"
          value={term}
          onChange={onChange}
