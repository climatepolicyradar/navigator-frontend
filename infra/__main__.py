...
pr_settings = DeploymentSettings(
    "pr-settings",
    organization=pulumi.get_organization(),
    project=pulumi.get_project(),
    stack="cpr-review",
    github=DeploymentSettingsGithubArgs(
        # Template only: no direct push-to-deploy or previews
        deploy_commits=True,
        preview_pull_requests=False,
        pull_request_template=True,  # <-- marks this as the template
