...
export const NewFeatures = () => {
  ...
  const { featureValue, modalContent, modalTitle, popupCTA, popupDescription, popupImage, popupTitle } = LATEST_FEATURE;
  ...
  return (
    <>
      ...
      {latestUpdateIsNew && (
        <div className="fixed inset-0 z-90 p-4 flex flex-col justify-end pointer-events-none">
          <div className="w-[300px]">
            {popupImage && <Image src={popupImage.src} alt={popupImage.alt} height={200} width={300} className="w-full h-auto rounded-t-md" />}
            <Card className="max-w-[300px] !p-4 flex items-start gap-2 pointer-events-auto select-none !rounded-none !rounded-b-md">
              <div>
      ...
      <Modal isOpen={modalIsOpen} onClose={onModalClose} cardClasses="">
        <div className="h-full flex flex-col gap-4 w-[600px]">
