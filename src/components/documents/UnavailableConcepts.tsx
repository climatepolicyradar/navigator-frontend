...
export const UnavailableConcepts = ({ unavailableConcepts }: TProps) => (
  <div className="border-gray-200 flex flex-col gap-4 flex-1 mt-4 pt-10 border-t text-center text-gray-600 px-4">
    ...
    <p>Concept matching is currently in beta mode.</p>
    <p>Some concepts from your search are not be present in this document but might be present in other documents in this entry.</p>
    <p>
      The following concept {unavailableConcepts.length > 1 ? "s are" : " is"} not present in this document:
