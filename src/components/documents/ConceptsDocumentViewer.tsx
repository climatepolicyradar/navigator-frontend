    ...
    <section className="flex-1 flex" id="document-concepts-viewer">
      <FullWidth extraClasses="flex-1">
        <div id="document-container" className="flex flex-row flex-wrap lg:flex-nowrap lg:h-[80vh]">
          ...
          <div
            id="document-preview"
            className={`flex-1 relative order-last border-t border-t-gray-200 basis-full lg:basis-auto lg:border-t-0 lg:order-none lg:h-full md:border-gray-300 ${hasConcepts ? "lg:border-x" : "lg:border-r"}`}
          >
            {canPreview && (
              <EmbeddedPDF
                document={document}
