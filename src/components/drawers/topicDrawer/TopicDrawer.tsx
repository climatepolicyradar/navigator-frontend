    ...
    <Drawer open={open} onOpenChange={onOpenChange} title={topicName}>
      <div className="grid grid-cols-[120px_auto] gap-x-3 gap-y-2 text-sm text-text-secondary leading-5">
        ...
        <div>
          <PageLink
            ...
            className="underline underline-offset-4 decoration-border-normal hover:decoration-inky-blue"
          >
            View source data&nbsp;<span className="text-text-tertiary">{ARROW_UP_RIGHT}</span>
          </PageLink>
        </div>
      </div>

      <h3 className="mt-9 mb-5 text-lg text-text-primary font-heavy leading-6">Documents that mention this topic</h3>
      ...
      <p className="mt-3 text-sm text-text-tertiary italic">
        ...
        <PageLink
          href="/faq"
          hash="topics-faqs"
          className="inline-block underline underline-offset-4 decoration-border-normal hover:decoration-inky-blue"
        >
          Learn more
        </PageLink>
      </p>
