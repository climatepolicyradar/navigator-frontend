...
export const SearchMatchesButton = ({ count, dataAttribute, overideText, active, onClick }: TProps) => {
  return (
    <button
      ...
      onClick={onClick}
      className={`flex gap-1 items-center text-sm rounded-full border border-gray-200 py-1 px-2 transition hover:text-textNormal hover:bg-blue-100 hover:border-blue-200 active:bg-blue-600 active:text-white ${
