...
import { EMPTY_FILTERS, hasAnyFilters, type TSelectedFilters } from "@/utils/_experiment/suggestedFilterUtils";

const SESSION_STORAGE_KEY = "navigator-shadow-search-restore";

function isSelectedFilters(value: unknown): value is TSelectedFilters {
  if (!value || typeof value !== "object") return false;
  const keys: (keyof TSelectedFilters)[] = [
    "topics",
    "geos",
    "years",
    "documentTypes",
