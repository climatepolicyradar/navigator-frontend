...
import { IMetadata, TGeography, TFamilyPublic } from "@/types";
...
export const getFamilyMetadata = (family: TFamilyPublic, countries: TGeography[]): IMetadata[] => {
...
function getLitigationMetaData(family: TFamilyPublic, countries: TGeography[]): IMetadata[] {
  const metadata = [];
