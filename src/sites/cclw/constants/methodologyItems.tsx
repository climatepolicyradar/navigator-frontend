    ...
    content: (
      <>
        ...
        <p>
          ...
          place natural disaster risk management. In some instances, laws addressing disaster risk management and/or energy-related matters may have
          been included even where no explicit mention of climate change is made, given the close connection between these areas and climate change.
          Laws aimed at enhancing other areas of environmental action or environmental protection are not included unless they include provisions with
          directly relevant impacts on climate change action, such as a reduction in greenhouse gas emissions, significant enhancement or protection
          of carbon sinks, or if they expressly contribute to climate adaptation and resilience.
        </p>
      ...
      <>
        ...
        <ol>
          ...
          <li>
            ...
            disaster management policies, water policies, land use and forestry policies and health policies, which can make them difficult to
            identify.<a href="#note-i">[i]</a>
          </li>
          ...
          <li>
            ...
            government departments and ministries, and social protection programmes and safety nets. Loss and damage is the most recent policy
            response area included in the database. Our current categorisation accounts for documents that explicitly mention the term ‘loss and
            damage’ and is exhaustive for laws and policies that were passed from 2015 onward. Documents addressing loss and damage with regard to
            specific impacts, such as biodiversity loss or drought, but which do not use an explicit loss and damage framing, do not have the loss and
            damage tag.
          </li>
        </ol>
    ...
    content: (
      <>
        <p>
          ...
          percentage is based on emissions data from 2020. This data was last updated on Climate Change Laws of the World on 18 September 2023. The
          annually published Global Climate Risk Index analyses to what extent countries have been affected by the impacts of weather-related loss
          events (storms, floods, heat waves etc.). This data is from the Global Risk Index 2021 published by{" "}
