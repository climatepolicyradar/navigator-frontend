    ...
    <section>
      <div className="text-content px-4 container mb-12">
        ...
        <div id="content-scope">
          ...
          <p>
            <b className="font-bold">The database focuses exclusively on climate change-related laws and policies</b>. We define climate
          ...
          <p>
            ...
            low-carbon energy supply; restrict the development of fossil fuel-based infrastructure; promote or mandate low-carbon buildings; set
            carbon pricing policy; lower industry emissions; tackle deforestation and promote or mandate sustainable land use; contain other
            mitigation efforts; cover climate-related research and development; promote or mandate low-carbon transport; enhance adaptation
            capabilities; or put in place natural disaster risk management. In some instances, laws addressing disaster risk management and/or
            energy-related matters may have been included even where no explicit mention of climate change is made, given the close connection between
            these areas and climate change. Laws aimed at enhancing other areas of environmental action or environmental protection are not included
            unless they include provisions with directly relevant impacts on climate change action, such as a reduction in greenhouse gas emissions,
            significant enhancement or protection of carbon sinks, or if they expressly contribute to climate adaptation and resilience.
          </p>

          <p>
            <b className="font-bold">The database includes legislation and policy at the national and sectoral levels only</b>. At present, it
            excludes information about the policy response of sub-national governments. It also excludes international legislation, such as treaties.
            Documents submitted only to international organisations such as the UNFCCC are generally excluded unless they have been converted into
            specific legislation or formally adopted as executive policies. In most cases, this means that documents such as the Long-term Low
            Emissions Development Strategies and National Adaptation Plans submitted to UNFCCC registries are not included. Users are encouraged to
            consult the relevant UN websites where these documents may be relevant to their search. For EU member states, laws transposing EU
            Directives are in the process of being added to the database, along with the relevant EU law, since in many instances these may contain
            additional relevant provisions. Where possible these additional provisions have been noted in the description of the relevant law.{" "}
          </p>

          <p>
            <b className="font-bold">Documents included in the database must have full legal force</b>, having passed through the legislature or
            through an executive decision-making body,{" "}
            <b className="font-bold">and/or set out a current governmental policy objective or set of policy objectives</b>. To the best of our
            ability, we capture major amendments to legislation and update document summaries accordingly. Where we become aware that laws are
            outdated, either because they have been repealed or replaced, or because they were in force for a limited time period, these documents may
            be removed from the database. In general, precedence is given to the document with the highest possible status dealing with a given
            matter. In some instances, policies or regulations aimed at giving effect to legislation or regulation of a higher order (‘parent
            legislation’), such as statutory instruments or other guidance adopted to provide detail on the implementation of an act of parliament,
            may be included in the database alongside their ‘parent legislation’ where these provide a significantly more detailed picture.
          </p>
        </div>
        ...
        <div id="content-definitions-in-use">
          ...
          <p>
            ...
            . Where the same body holds both legislative and executive power, a determination of whether a document constitutes a law or policy is
          ...
          <ol>
            <li>
              <b className="font-bold">Mitigation</b>: Mitigation laws and policies refer to a legislative or executive disposition focused on curbing
              ...
              providing additional funding for research and development into low-carbon technologies. Laws and policies addressing forests and land
              use are included if they explicitly support climate change mitigation through activities that reduce emissions and increase carbon
              removals. General forest management and conservation laws are not included, even if they may have implicit consequences for climate
              change mitigation.
            </li>
            ...
            <li>
              ...
              climate change. We conducted a comprehensive review of adaptation laws and policies in 2018 and have added documents since then. Note
              that in many cases, climate change adaptation responses may be embedded in development policies, general planning policies,
              risk-reduction and disaster management policies, water policies, land use and forestry policies and health policies, which can make them
              difficult to identify.<a href="#note-i">[i]</a>
            </li>

            <li>
              <b className="font-bold">Disaster risk management</b>: Laws and policies governing countries’ approaches to disaster risk management
              ...
              these documents fall within the database scope, as laws and policies often target natural and human disasters in a holistic manner,
              making it harder to isolate climate-related adverse events. Nonetheless, in determining whether a disaster risk management law or policy
              falls within scope, our researchers will usually consider whether the document relates to the types of disaster that are expected to
              become more frequent due to climate change, such as hurricanes, typhoons, flooding, heatwaves, droughts, forest fires and sea-level rise
              (this list is non-exhaustive). In some cases these laws and policies may constitute exceptions to the general rule that laws and
              policies must be explicitly ‘climate-motivated’ to justify their inclusion.
            </li>

            <li>
              <b className="font-bold">Loss and damage</b>: We define loss and damage-related laws and policies as those that explicitly reduce the
              ...
              victims of climate-related loss and damage. The guiding definition of loss and damage includes both economic and non-economic losses
              that arise due to climate impacts that are made more frequent or more severe by anthropogenic greenhouse gas emissions. Policy measures
              may include national climate relief funds, risk transfer mechanisms, internal relocation arrangements, mainstreaming loss and damage
              across government departments and ministries, and social protection programmes and safety nets. Loss and damage is the most recent
              policy response area included in the database. Our current categorisation accounts for documents that explicitly mention the term ‘loss
              and damage’ and is exhaustive for laws and policies that were passed from 2015 onward. Documents addressing loss and damage with regard
              to specific impacts, such as biodiversity loss or drought, but which do not use an explicit loss and damage framing, do not have the
              loss and damage tag.
            </li>
          </ol>
          ...
          <p>
            ...
            multi-sectoral action plans that serve to provide a unifying basis for climate change action within a country, to documents with a
            narrower focus but that nonetheless establish a governance framework for a specific aspect of climate action, such as a national
            low-carbon energy policy. Data users interested in this sub-set of climate laws are advised to review the sub-set of laws tagged as
            frameworks and to use their discretion to determine which of these laws may be most relevant to their subject of inquiry.
          </p>

          <p>
            Framework documents are tagged to indicate the policy response area(s) to which they relate, whether mitigation, adaptation or disaster
            risk management.
          </p>
          ...
          <p>
            ...
            also be categorised as related to Disaster Risk Management (DRM), Adaptation, or Social Development. We also consider whether laws relate
            primarily to urban or rural sectors of the economy and/or to coastal zones. We currently only cover waste laws that explicitly mention
        ...
        <div id="content-collection">
          <p>
            ...
            enable users to access relevant information when it becomes available. Updates to the data are now collected on a rolling basis from
            official sources such as government websites, parliamentary records and court documents. Some of our key strategies for identifying new
            documents include: review of documentation submitted to UNFCCC processes, such as NDCs; country-specific research (focused on the G20);
            thematic reviews of legislation (e.g. net zero laws); and media and social media alerts. The efforts of the CCLW team are regularly
        ...
        <div id="content-principles">
          ...
          <p>
            ...
            and the specific expertise of our researchers and contributors may all result in information for certain countries being more
            comprehensive than others. Our current data collection process prioritises the most recently passed laws and policies.
          </p>
          <p>
            <b className="font-bold">
            ...
            software to understand the content of these records. The determination of whether a given law is in scope, as well as its categorisation
            in accordance with the definitions outlined above, may therefore be open to differing interpretations.
          </p>
          <p>
            <b className="font-bold">
        ...
        <div id="content-definitions-not-in-use">
          <p>
            ...
            <b className="font-bold">
              We are working with our partners at Climate Policy Radar to develop new automated processes to improve our classification of documents
              and apply these classifications to the entire dataset
            </b>
            .
          </p>
          <p>
          ...
          <p>
            ...
            them with the specific types of instrument they employ to achieve their stated aims and objectives. The vast majority of documents relate
        ...
        <div id="content-notes">
          <p>
            ...
            <span className="block" id="note-ii">
              ...
              of Climate Change Legislation in 99 Countries. London: Grantham Research Institute on Climate Change and the Environment; Nash S,
              Steurer R (2019) Taking stock of Climate Change Acts in Europe: Living policy processes or symbolic gestures? Climate Policy 3:1; World
              Bank (2020) World Bank Reference Guide to Climate Change Framework Legislation. EFI Insight-Governance. Washington, DC: World Bank.
            </span>
            <span className="block" id="note-iii">
              ...
              (Treasure), and Governance and Planning (Organization). We developed these adaptations to enhance the searchability of the database and
              to enable observations of particular relevance to climate change practitioners.
            </span>
          </p>
        </div>
        ...
        <div id="content-annex-1">
          <p>
            ...
            . Data on targets was originally collected in 2018 following a review of the Nationally Determined Contributions (NDCs) submitted by
            parties to the Paris Agreement and around 1,500 climate change laws and policies then available in the CCLW database. In some instances
            where the text of the law was unavailable press releases or other secondary source material regarding the nature of targets set may have
            been consulted. Until January 2023, data was updated as new laws were added to the database but data for some countries may be incomplete.
