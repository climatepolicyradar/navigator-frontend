...
const Instructions = ({ isFAQ = false }: TProps) => {
  return (
    <div className="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 text-center max-w-screen-lg mx-auto">
      ...
      {isFAQ && (
        <div className="border-t md:border-t-0 md:border-l border-white py-5 lg:py-0 flex flex-col items-center lg:px-4" data-cy="feature-video">
          <div className="mb-6 h-[80px] flex items-center justify-center relative">
            <img src="/images/video.png" alt="Video icon" className="max-h-full" />
          </div>
          <p className="mb-6">Watch a quick demo to see how to use our resource</p>
        </div>
      )}
    </div>
  );
