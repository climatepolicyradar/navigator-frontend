        ...
        <div className="text-content px-4 container mb-12">
          ...
          >
            <p>
              ...
              is an affiliate of the Earth Institute and the Columbia Climate School. Climate Change Laws of the World builds on more than a decade of
              data collection by the Grantham Research Institute at LSE and the Sabin Center at Columbia Law School. Work to identify cases is now
          ...
          <Acknowledgement partnerImage={{ url: "https://www.ipu.org/", imageUrl: "IPU_logo.png", imageAlt: "Inter-Parliamentary Union logo" }}>
            <p>
              ...
              organisation of national parliaments. Through the Grantham Research Institute’s ongoing partnership with IPU, we work to develop timely
              and relevant outputs on climate change legislation and policy that can inform the work of IPU’s members.
            </p>
          </Acknowledgement>
          <Acknowledgement
            partnerImage={{
          ...
          >
            <p>
              ...
              change law, democratisation and transitional constitutionalism, and constitutional theory. Data on climate-relevant constitutions found
              in the Climate Change Laws of the World database is gathered and maintained through an ongoing collaboration with ECCL.
            </p>
          </Acknowledgement>
          <Acknowledgement
            partnerImage={{
          ...
          >
            <p>
              ...
              collaborates with researchers at the University of Sussex supporting the non-proliferation initiative to exchange information on
              national level laws and policies regarding moratoria, bans, and limits placed on fossil fuel use and/or divestment from fossil fuels.
            </p>
          </Acknowledgement>
        </div>
      </section>
