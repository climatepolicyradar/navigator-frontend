...
export const FamilyAttributesSchema = v.object(
  ...
  "Attributes are not shaped correctly for a family"
);
...
export const DocumentAttributesSchema = v.object(
  ...
  "Attributes are not shaped correctly for a document"
);
...
export const CollectionAttributesSchema = v.object(
  ...
  "Attributes are not shaped correctly for a collection"
);
