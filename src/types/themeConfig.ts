...
export type TFamilyPageBlock = "collection" | "debug" | "documents" | "metadata" | "note" | "summary" | "topics";
export type TGeographyPageBlock = "debug" | "legislativeProcess" | "recents" | "statistics" | "subdivisions" | "targets";
